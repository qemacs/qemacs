...
static CmdDef basic_commands[] = {
    ...
    CMD2( KEY_CTRL('d'), KEY_DELETE,
          "delete-char", do_delete_char, ESi, "*p", "")
    CMD2( 127, KEY_NONE,
          "backward-delete-char", do_backspace, ESi, "*p", "")
    ...
    CMD3( KEY_META(KEY_DEL), KEY_META(KEY_BS),
          "backward-kill-word", do_kill_word, ESi, -1, "P", "")
    CMD3( KEY_META('d'), KEY_NONE,
          "kill-word", do_kill_word, ESi, +1, "P", "")
    ...
    CMD2( KEY_META('~'), KEY_NONE,
          "not-modified", do_not_modified, ESi, "p", "")
    CMD2( KEY_NONE, KEY_NONE,
    ...
    CMD2( KEY_CTRLX(KEY_CTRL('c')), KEY_NONE,
          "exit-qemacs", do_exit_qemacs, ESi, "p", "")
...
CmdDef popup_commands[] = {
    ...
    CMD3( '/', KEY_NONE,
          "popup-isearch", do_isearch, ESii, 1, "vp" , "")
    CMD_DEF_END,
};
